...
jQuery(document).ready(function () {
    ...
    var bw = new Date();
    jQuery(".js-info_dia-next2").text(
        +b.getDate() + 7 > 30 ? +b.getDate() - 23 : +b.getDate() + 7
    );
    jQuery(".js-info_mes-nombre-next2").text(
        +b.getDate() + 7 > 30
            ? monthNames[b.getMonth() + 1]
            : monthNames[b.getMonth()]
    );
    jQuery(".js-info_dia").text(
        +b.getDate() - 10 <= 0 ? +b.getDate() + 20 : +b.getDate() - 10
    );
    jQuery(".js-info_mes-nombre").text(
        +b.getDate() - 10 <= 0
            ? monthNames[b.getMonth() - 1]
            : monthNames[b.getMonth()]
    );
